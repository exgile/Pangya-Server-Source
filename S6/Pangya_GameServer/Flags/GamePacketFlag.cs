namespace Pangya_GameServer.Flags
{
    ...
    public enum GamePacketFlag
    {
        ...
        PLAYER_PLAY_BONGDARI = 0x014A,
        PLAYER_SAVE_MACRO = 0x0069,
        PLAYER_OPEN_MAILBOX = 0x0142,
        PLAYER_READ_MAIL = 0x0144,
        PLAYER_RELEASE_MAILITEM = 0x0145,
        PLAYER_DELETE_MAIL = 0x0146,
        ...
        PLAYER_REQUEST_COOKIES_COUNT = 0x003D,
        PLAYER_BUY_ITEM_GAME = 0x001D,
        PLAYER_ENTER_TO_SHOP = 0x013F,
        ...
        // PLAYER_OPEN_TIKIPOINT
        PLAYER_OPEN_TIKIPOINT = 0x0126,
        ...
        // DIALY LOGIN
        PLAYER_REQUEST_CHECK_DAILY_ITEM = 0x016D,
        PLAYER_REQUEST_DAILY_REWARD = 0x016E,

        // ACHIEVEMENT
        PLAYER_CALL_ACHIEVEMENT = 0x0156,
        ...
        // QUEST
        PLAYER_LOAD_QUEST = 0x0151,//0x0150
