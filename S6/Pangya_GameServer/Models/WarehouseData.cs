...
using Pangya_GameServer.Tools;
using PangyaAPI.BinaryModels;
using PangyaAPI.Connector.Tools;
...
namespace Pangya_GameServer.Models
{
    public class WarehouseData
    {
        ...
        {
            if (!(IFFTools.GetItemGroup(ItemTypeID) == IffGroupFlag.ITEM_TYPE_CLUB)) return false;
        ...
        public string GetSqlUpdateString()
        {
            ...
            try
            {
                ...
                SQLString.Append('^');
                SQLString.Append(Compare.IfCompare<byte>(Program.IFF.IsSelfDesign(ItemTypeID), 1, 0));
                SQLString.Append('^');
