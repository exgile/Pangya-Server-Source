# Pangya-Server-Source Challenges/S6
...
* 2st: extract the [Pangya Client](Pangya_ClientFiles/Pangya_Challenges.rar) file where the Client is(update5 e updatelist são os mesmos)
